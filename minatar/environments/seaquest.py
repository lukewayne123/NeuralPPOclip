...
class Env:
    ...
    def act(self, a):
        self.steps += 1
        #print("[Iter{}] step: {}".format(self.iter, self.steps))
        #print(self.state())
        #print("({}, {}); oxygen: {}; action: {}".format(self.sub_x, self.sub_y, self.oxygen, a))
        #print("Surface: {}; drivers: {}".format(self.surface, self.diver_count))
        r = 0
        if(self.terminal):
